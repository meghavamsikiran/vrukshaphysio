...
export default function Footer() {
  ...
  return (
    <footer className="bg-[#0B2C24] text-white relative">
      {/* Wave separator */}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          ...
          <div className="lg:col-span-1">
            ...
            <div className="flex gap-3">
              ...
              <a
                href={CALL_URL}
                className="w-10 h-10 rounded-lg bg-[#C5A880]/10 flex items-center justify-center text-[#C5A880] hover:bg-[#C5A880] hover:text-[#0B2C24] transition-all duration-300"
                aria-label="Call"
              >
      ...
      {showScrollTop && (
        <button
          onClick={scrollToTop}
          className="fixed bottom-6 left-6 z-40 w-12 h-12 rounded-full bg-[#C5A880] text-[#0B2C24] shadow-lg flex items-center justify-center hover:bg-white transition-all duration-300 hover:scale-110"
