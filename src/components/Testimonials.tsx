...
export default function Testimonials() {
  ...
  return (
    <section id="testimonials" className="py-20 md:py-28 bg-white border-t border-[#E2E8F0]">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        {/* Carousel Container */}
        <div className="relative bg-[#F8FAFC]/60 rounded-3xl p-8 md:p-12 border border-[#E2E8F0] min-h-[300px] flex flex-col justify-between overflow-hidden shadow-sm">
          {/* Quote Icon */}
          ...
          <div className="relative z-10">
            ...
            {/* Testimonial text */}
            <p className="text-[#0C2340] text-lg md:text-xl italic leading-relaxed mb-8 font-heading">
              &ldquo;{current.quote}&rdquo;
            </p>

            {/* Profile detail */}
            <div>
              <h4 className="text-base font-bold text-[#0C2340] font-sans uppercase tracking-wider">
                {current.name}
              </h4>
          ...
          {/* Navigation Controls */}
          <div className="flex items-center justify-between mt-8 relative z-10 border-t border-[#E2E8F0] pt-6">
            <button
              onClick={handlePrev}
              className="p-2.5 rounded-full border border-[#E2E8F0] text-[#0D9488] hover:bg-[#0C2340] hover:text-[#F8FAFC] hover:border-[#0C2340] transition-colors"
              ...
              {testimonials.map((_, i) => (
                <button
                  ...
                  className={`w-1.5 h-1.5 rounded-full transition-all duration-300 ${
                    i === index ? 'w-5 bg-[#0C2340]' : 'bg-[#E2E8F0]'
                  }`}
