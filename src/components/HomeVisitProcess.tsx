...
export default function HomeVisitProcess() {
  ...
  return (
    <section id="process" className="py-20 md:py-28 bg-[#0C2340] text-white relative overflow-hidden" ref={ref}>
      {/* Decorative gradient blur */}
      <div className="absolute top-1/4 left-1/4 w-96 h-96 bg-[#C5A880]/10 rounded-full blur-3xl -z-10"></div>
      <div className="absolute bottom-1/4 right-1/4 w-96 h-96 bg-[#0D9488]/25 rounded-full blur-3xl -z-10"></div>
          ...
          {steps.map((step, i) => {
            ...
            return (
              ...
              >
                ...
                {/* Number Badge */}
                <div className="w-8 h-8 rounded-full bg-[#C5A880] flex items-center justify-center text-[#0C2340] text-xs font-bold mb-6 relative z-10">
                  {step.number}
                </div>
