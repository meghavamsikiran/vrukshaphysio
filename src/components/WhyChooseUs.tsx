...
export default function WhyChooseUs() {
  ...
  return (
    <section id="why-choose-us" className="py-20 md:py-28 bg-[#F4F9FC] border-t border-[#E2EDF3]" ref={ref}>
          ...
          {cards.map((card) => {
            ...
            return (
              <motion.div
                ...
                className="bg-white rounded-2xl p-8 border border-[#E2EDF3] shadow-sm hover:border-[#C5A880] hover:shadow-md transition-all duration-300 flex flex-col items-start text-left group"
              >
                ...
                <h3 className="text-lg font-bold text-[#004F95] mb-3 font-sans">
                  {card.title}
                </h3>
                <p className="text-[#0FA3B1] text-sm leading-relaxed">
                  {card.desc}
                </p>
              </motion.div>
            );
